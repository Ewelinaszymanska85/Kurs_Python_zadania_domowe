...
class InfrastructureMonitor:
    """Monitoruje stan infrastruktury AWS i zapisuje histori─Ö do CSV."""
    ...
    def check_ec2_instances(self) -> tuple[str, int, int]:
        ...
        try:
            ...
            print(f"[ERROR] Nie uda┼éo si─Ö pobra─ç instancji EC2: {exc}")
            return "ERROR", 0, 0

    def check_ebs_volumes(self) -> tuple[str, float]:
        """Sprawdza wolumeny EBS pod k─ůtem stanu innych ni┼╝ 'in-use'/'available'."""
        try:
            ...
            print(f"[ERROR] Nie uda┼éo si─Ö pobra─ç wolumen├│w EBS: {exc}")
            return "ERROR", 0.0
    ...
    def run_check(self, url: str) -> None:
        ...
        print(f"[{volume_status}] EBS: {problem_ratio:.1f}% problematycznych wolumen├│w")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n[INFO] Monitoring zatrzymany przez u┼╝ytkownika.")
